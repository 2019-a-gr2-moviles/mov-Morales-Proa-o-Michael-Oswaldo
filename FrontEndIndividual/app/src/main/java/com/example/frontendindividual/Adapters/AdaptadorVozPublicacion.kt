...
class AdaptadorVozPublicacion  (private val listaPublicaciones:List<Mascota>,
                                private val contexto: BuscarMascotaActivity,
                                private val recyclerview: RecyclerView
): RecyclerView.Adapter<AdaptadorVozPublicacion.MyViewHolder>() {
    ...
    override fun onBindViewHolder(myViewHolder: AdaptadorVozPublicacion.MyViewHolder, position: Int) {
